          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
            ...
            <div className="relative w-full md:w-96 group">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-accent/20 outline-none transition-all shadow-soft font-medium"
                value={searchTerm}
                    ...
                    <div className="bg-slate-50/50 px-8 py-6 border-b border-slate-100 flex flex-wrap justify-between items-center gap-6">
                      <div className="flex gap-12">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-black text-accent">${order.total_amount}</p>
                        </div>
