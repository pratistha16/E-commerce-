...
import ProvisionMerchantModal from '@/components/admin/ProvisionMerchantModal';
    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      <div className="flex justify-between items-end">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-blue-600 shadow-xl shadow-slate-900/10 transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95"
        >
        ...
        <div className="p-8 border-b border-gray-100 bg-gray-50/50 flex flex-col md:flex-row gap-6 justify-between items-center">
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-12 pr-6 py-4 bg-white border-none rounded-2xl focus:ring-2 focus:ring-blue-600/20 shadow-sm transition-all text-sm font-bold text-slate-900 placeholder:text-slate-400"
              value={search}
